    ...
    <Row>
     ...
     <Row>
      ...
      <div className="topButton">
        ...
        <h1 style={{color:"#499eca",fontSize:"20px",position:"absolute",padding:"0 0 0 25px",marginTop:"-40px"}}>查询病历</h1>
      ...
      <div style={{width:"680px",height:"490px",textAlign:"center"}}>
        {/* <img src={fakeformdata3} style={{width:"650px",padding:"10px 0 0 0px"}} ></img> */}
        {/* <img src={fakeformdata4} style={{width:"650px",padding:"0 0 0 0"}} ></img> */}
        <TableComponent2 ref={this.myRef} style={{width:"650px",padding:"10px 0 0 0px"}} filteredInfo={this.state.reset==true?null:{name:this.state.name==undefined?null:[this.state.name],patientnumber:this.state.patientnumber==undefined?null:[this.state.patientnumber],registerdate:this.state.registerdate==undefined?null:[this.state.registerdate]}}/>
